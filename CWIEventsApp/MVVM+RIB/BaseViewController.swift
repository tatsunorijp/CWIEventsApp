...
class BaseViewController: UIViewController {
    ...
    final func configureNavigationBar() {
        ...
        navigationController.navigationBar.barTintColor = Asset.Colors.primary500.color
        navigationController.navigationBar.backgroundColor = Asset.Colors.primary500.color
